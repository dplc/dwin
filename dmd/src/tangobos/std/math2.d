...
alias tango.math.Math.trunc trunc;
...
real cot(real x)
{
    return 1.0L/tango.math.Math.tan(x);
}
...
real sec(real x)
{
    return 1.0L/tango.math.Math.cos(x);
}
...
real cosec(real x)
{
    return 1.0L/tango.math.Math.sin(x);
}
...
real coth(real x)
{
	return 1.0L / tango.math.Math.tanh(x);
}
...
/+ alias tango.math.Math.acosh acosh;
