...
private static import tango.math.Math;
private static import tango.math.IEEE;
...
{
    return tango.math.IEEE.ldexp(n, exp);
}
...
alias tango.stdc.math.isnan isnan;
...
int isfinite(real x)
{
    return tango.stdc.math.isfinite(x);
}
...
alias tango.stdc.math.isnormal isnormal;
...
int issubnormal(float x) { return tango.stdc.math.fpclassify(x) == FP_SUBNORMAL; }
...
int issubnormal(double x) { return tango.stdc.math.fpclassify(x) == FP_SUBNORMAL; }
...
int issubnormal(real x) { return tango.stdc.math.fpclassify(x) == FP_SUBNORMAL; }
...
int isinf(real x) { return tango.stdc.math.fpclassify(x)==FP_INFINITE; }
...
alias tango.stdc.math.signbit signbit;
...
int feqrel(real x,real y){ return tango.math.IEEE.feqrel(x,y); }
