...
public class DirectoryFieldEditor : StringButtonFieldEditor {
    ...
    protected override String changePressed() {
        ...
        return d.absolute(tango.sys.Environment.Environment.cwd).toString;
//return FileSystem.toAbsolute( d ).native.toString; // January 14, 2011 by yidabu http://www.d-programming-language-china.org/
    }
