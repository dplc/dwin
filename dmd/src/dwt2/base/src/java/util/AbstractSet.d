...
abstract class AbstractSet : AbstractCollection, Set {
    ...
    public Iterator iterator(){ return null; }//{ return super.iterator(); }
    ...
    public int      size(){ return 0; }//{ return super.size(); }
    public Object[] toArray(){ return super.toArray(); }
    public Object[] toArray(Object[] a){ return super.toArray(a); }
    public String   toString(){ return super.toString(); }

    // only for D
    public int opApply (int delegate(ref Object value) dg){ return true; } //{ return super.opApply(dg); } //for compiler happy yidabu January 15, 2011
}
