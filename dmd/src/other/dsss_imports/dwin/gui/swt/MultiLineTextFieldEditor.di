 ...
 ***********************************************************************/
module dwin.gui.swt.MultiLineTextFieldEditor;

version(SWT):

//import org.eclipse.cdt.managedbuilder.internal.ui.ManagedBuilderUIMessages;
private import org.eclipse.jface.preference.FieldEditor;
...
private import org.eclipse.swt.layout.GridData;
private import org.eclipse.swt.widgets.Composite;
private import org.eclipse.swt.widgets.Label;
...
public class MultiLineTextFieldEditor : FieldEditor {
    ...
    private int widthHint = 100;  //since Apr 21, 2009, yidabu
    private int heightHint = 70;
     ...
     * @param labelText the label text of the field editor
     * @param parent the parent of the field editor's control
     * @param widthHint width of the text Control 
     * @param heightHint height of the text Control 
     */
    public this(String name, String labelText, Composite parent, int widhtHint, int heightHint) {
