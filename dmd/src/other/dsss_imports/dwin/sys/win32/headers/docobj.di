...
module dwin.sys.win32.headers.docobj;
...
interface IOleCommandTarget : public IUnknown {
	HRESULT QueryStatus(DWINGUID*, ULONG, ref OLECMD, ref OLECMDTEXT);
	HRESULT Exec(DWINGUID*, DWORD, DWORD, DWINVARIANT*, ref DWINVARIANT);
}
/*
