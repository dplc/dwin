...
const size_t  FREEIMAGE_MAJOR_VERSION = 3,
...
const size_t FI_RGBA_RGB_MASK	= (FI_RGBA_RED_MASK|FI_RGBA_GREEN_MASK|FI_RGBA_BLUE_MASK);
...
const size_t  FIICC_DEFAULT       = 0x00,
...
class FreeImageBitmap
{
    ...
    this(uint width, size_t height, size_t bpp)
    {
