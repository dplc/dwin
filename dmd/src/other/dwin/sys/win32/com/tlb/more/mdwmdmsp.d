...
// MDServiceProviderHD Class
abstract class MDServiceProvider {
  mixin(uuid("896e73f0-3851-11d3-aa54-00c04fd22f8c"));
  // static DWINGUID CLSID = { 0x896e73f0, 0x3851, 0x11d3, 0xaa, 0x54, 0x00, 0xc0, 0x4f, 0xd2, 0x2f, 0x8c };
  mixin Interfaces!(IMDServiceProvider);
}

// MDSPEnumDevice Class
abstract class MDSPEnumDevice {
  mixin(uuid("896e742a-3851-11d3-aa54-00c04fd22f8c"));
  // static DWINGUID CLSID = { 0x896e742a, 0x3851, 0x11d3, 0xaa, 0x54, 0x00, 0xc0, 0x4f, 0xd2, 0x2f, 0x8c };
  mixin Interfaces!(IMDSPEnumDevice);
}

// MDSPDevice Class
abstract class MDSPDevice {
  mixin(uuid("896e742c-3851-11d3-aa54-00c04fd22f8c"));
  // static DWINGUID CLSID = { 0x896e742c, 0x3851, 0x11d3, 0xaa, 0x54, 0x00, 0xc0, 0x4f, 0xd2, 0x2f, 0x8c };
  mixin Interfaces!(IMDSPDevice);
}

// MDSPEnumStorage Class
abstract class MDSPEnumStorage {
  mixin(uuid("896e7430-3851-11d3-aa54-00c04fd22f8c"));
  // static DWINGUID CLSID = { 0x896e7430, 0x3851, 0x11d3, 0xaa, 0x54, 0x00, 0xc0, 0x4f, 0xd2, 0x2f, 0x8c };
  mixin Interfaces!(IMDSPEnumStorage);
}

// MDSPStorage Class
abstract class MDSPStorage {
  mixin(uuid("896e7432-3851-11d3-aa54-00c04fd22f8c"));
  // static DWINGUID CLSID = { 0x896e7432, 0x3851, 0x11d3, 0xaa, 0x54, 0x00, 0xc0, 0x4f, 0xd2, 0x2f, 0x8c };
  mixin Interfaces!(IMDSPStorage);
}

// MDSPStorageGlobals Class
abstract class MDSPStorageGlobals {
  mixin(uuid("896e7434-3851-11d3-aa54-00c04fd22f8c"));
  // static DWINGUID CLSID = { 0x896e7434, 0x3851, 0x11d3, 0xaa, 0x54, 0x00, 0xc0, 0x4f, 0xd2, 0x2f, 0x8c };
