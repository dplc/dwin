...
//module dwin.sys.win32.com.tlb.more.wbemscripting;
module dwin.sys.win32.com.tlb.more.wbemdisp;
...
interface ISWbemServices : IDispatch {
  ...
  // static DWINGUID IID = { 0x76a6415c, 0xcb41, 0x11d1, 0x8b, 0x02, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
...
interface ISWbemObject : IDispatch {
  ...
  // static DWINGUID IID = { 0x76a6415a, 0xcb41, 0x11d1, 0x8b, 0x02, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  // Save this Object
  ...
  /*[id(0x00000017)]*/ int get_Derivation_(out DWINVARIANT strClassNameArray);
...
interface ISWbemObjectPath : IDispatch {
  ...
  // static DWINGUID IID = { 0x5791bc27, 0xce9c, 0x11d1, 0x97, 0xbf, 0x00, 0x00, 0xf8, 0x1e, 0x84, 0x9c };
  // The full path
  /*[id(0x00000000)]*/ int get_Path(out wchar* strPath);
  // The full path
  /*[id(0x00000000)]*/ int set_Path(wchar* strPath);
  // The relative path
  /*[id(0x00000001)]*/ int get_RelPath(out wchar* strRelPath);
  // The relative path
  /*[id(0x00000001)]*/ int set_RelPath(wchar* strRelPath);
  // The name of the Server
  /*[id(0x00000002)]*/ int get_Server(out wchar* strServer);
  // The name of the Server
  /*[id(0x00000002)]*/ int set_Server(wchar* strServer);
  // The Namespace path
  /*[id(0x00000003)]*/ int get_Namespace(out wchar* strNamespace);
  // The Namespace path
  /*[id(0x00000003)]*/ int set_Namespace(wchar* strNamespace);
  ...
  // The Display Name for this path
  /*[id(0x00000005)]*/ int set_DisplayName(wchar* strDisplayName);
  // The Class name
  /*[id(0x00000006)]*/ int get_Class(out wchar* strClass);
  // The Class name
  /*[id(0x00000006)]*/ int set_Class(wchar* strClass);
...
interface ISWbemNamedValueSet : IDispatch {
  ...
  /*[id(0x00000002)]*/ int Add(wchar* strName, DWINVARIANT* varValue, int iFlags, out ISWbemNamedValue objWbemNamedValue);
...
interface ISWbemNamedValue : IDispatch {
  ...
  // static DWINGUID IID = { 0x76a64164, 0xcb41, 0x11d1, 0x8b, 0x02, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  // The Value of this Named element
  /*[id(0x00000000)]*/ int get_Value(out DWINVARIANT varValue);
  // The Value of this Named element
  /*[id(0x00000000)]*/ int set_Value(DWINVARIANT* varValue);
...
interface ISWbemSecurity : IDispatch {
  ...
  // static DWINGUID IID = { 0xb54d66e6, 0x2287, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  ...
  // The security impersonation level
  /*[id(0x00000001)]*/ int set_ImpersonationLevel(WbemImpersonationLevelEnum iImpersonationLevel);
  ...
  // The security authentication level
  /*[id(0x00000002)]*/ int set_AuthenticationLevel(WbemAuthenticationLevelEnum iAuthenticationLevel);
...
interface ISWbemPrivilegeSet : IDispatch {
  ...
  // static DWINGUID IID = { 0x26ee67bf, 0x5804, 0x11d2, 0x8b, 0x4a, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IUnknown pUnk);
...
interface ISWbemPrivilege : IDispatch {
  ...
  // static DWINGUID IID = { 0x26ee67bd, 0x5804, 0x11d2, 0x8b, 0x4a, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  // Whether the Privilege is to be enabled or disabled
  /*[id(0x00000000)]*/ int get_IsEnabled(out short bIsEnabled);
  // Whether the Privilege is to be enabled or disabled
  /*[id(0x00000000)]*/ int set_IsEnabled(short bIsEnabled);
...
interface ISWbemObjectSet : IDispatch {
  ...
  // static DWINGUID IID = { 0x76a6415f, 0xcb41, 0x11d1, 0x8b, 0x02, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IUnknown pUnk);
...
interface ISWbemQualifierSet : IDispatch {
  ...
  // static DWINGUID IID = { 0x9b16ed16, 0xd3df, 0x11d1, 0x8b, 0x08, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IUnknown pUnk);
  ...
  /*[id(0x00000002)]*/ int Add(wchar* strName, DWINVARIANT* varVal, short bPropagatesToSubclass, short bPropagatesToInstance, short bIsOverridable, int iFlags, out ISWbemQualifier objWbemQualifier);
...
interface ISWbemQualifier : IDispatch {
  ...
  // static DWINGUID IID = { 0x79b05932, 0xd3b7, 0x11d1, 0x8b, 0x06, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  ...
  // Determines whether this Qualifier can propagate to subclasses
  /*[id(0x00000003)]*/ int set_PropagatesToSubclass(short bPropagatesToSubclass);
  ...
  // Determines whether this Qualifier can propagate to instances
  /*[id(0x00000004)]*/ int set_PropagatesToInstance(short bPropagatesToInstance);
  ...
  // Determines whether this Qualifier can be overridden where propagated
  /*[id(0x00000005)]*/ int set_IsOverridable(short bIsOverridable);
...
interface ISWbemPropertySet : IDispatch {
  ...
  // static DWINGUID IID = { 0xdea0a7b2, 0xd4ba, 0x11d1, 0x8b, 0x09, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IUnknown pUnk);
...
interface ISWbemProperty : IDispatch {
  ...
  // static DWINGUID IID = { 0x1a388f98, 0xd4ba, 0x11d1, 0x8b, 0x09, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
...
interface ISWbemMethodSet : IDispatch {
  ...
  // static DWINGUID IID = { 0xc93ba292, 0xd955, 0x11d1, 0x8b, 0x09, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IUnknown pUnk);
...
interface ISWbemMethod : IDispatch {
  ...
  // static DWINGUID IID = { 0x422e8e90, 0xd955, 0x11d1, 0x8b, 0x09, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
...
interface ISWbemEventSource : IDispatch {
  ...
  // static DWINGUID IID = { 0x27d54d92, 0x0ebe, 0x11d2, 0x8b, 0x22, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
...
interface ISWbemLocator : IDispatch {
  ...
  // static DWINGUID IID = { 0x76a6415b, 0xcb41, 0x11d1, 0x8b, 0x02, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
...
interface ISWbemLastError : ISWbemObject {
  ...
  // static DWINGUID IID = { 0xd962db84, 0xd4bb, 0x11d1, 0x8b, 0x09, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
}
...
interface ISWbemSinkEvents : IDispatch {
  ...
  // static DWINGUID IID = { 0x75718ca0, 0xf029, 0x11d1, 0xa1, 0xac, 0x00, 0xc0, 0x4f, 0xb6, 0xc2, 0x23 };
...
interface ISWbemSink : IDispatch {
  ...
  // static DWINGUID IID = { 0x75718c9f, 0xf029, 0x11d1, 0xa1, 0xac, 0x00, 0xc0, 0x4f, 0xb6, 0xc2, 0x23 };
...
interface ISWbemServicesEx : ISWbemServices {
  ...
  // static DWINGUID IID = { 0xd2f68443, 0x85dc, 0x427e, 0x91, 0xd8, 0x36, 0x65, 0x54, 0xcc, 0x75, 0x4c };
...
interface ISWbemObjectEx : ISWbemObject {
  ...
  // static DWINGUID IID = { 0x269ad56a, 0x8a67, 0x4129, 0xbc, 0x8c, 0x05, 0x06, 0xdc, 0xfe, 0x98, 0x80 };
  // Refresh this Object
...
interface ISWbemDateTime : IDispatch {
  ...
  // The Microseconds component of the value (must be in the range 0-999999)
  /*[id(0x0000000D)]*/ int set_Microseconds(int iMicroseconds);
  ...
  // Indicates whether this value describes an absolute date and time or is an interval
  /*[id(0x00000011)]*/ int set_IsInterval(short bIsInterval);
  // Retrieve value in DWINVARIANT compatible (VT_DATE) format
  /*[id(0x00000012)]*/ int GetVarDate(short bIsLocal, out double dVarDate);
  // Set the value using DWINVARIANT compatible (VT_DATE) format
...
interface ISWbemRefresher : IDispatch {
  ...
  // static DWINGUID IID = { 0x14d8250e, 0xd9c2, 0x11d3, 0xb3, 0x8f, 0x00, 0x10, 0x5a, 0x1f, 0x47, 0x3a };
  /*[id(0xFFFFFFFC)]*/ int get__NewEnum(out IUnknown pUnk);
  ...
  // Whether to attempt auto-reconnection to a remote provider
  /*[id(0x00000006)]*/ int set_AutoReconnect(short bCount);
  // Delete all items in this collection
...
interface ISWbemRefreshableItem : IDispatch {
  ...
  // static DWINGUID IID = { 0x5ad4bf92, 0xdaab, 0x11d3, 0xb3, 0x8f, 0x00, 0x10, 0x5a, 0x1f, 0x47, 0x3a };
...
// Used to obtain Namespace connections
abstract class SWbemLocator {
  mixin(uuid("76a64158-cb41-11d1-8b02-00600806d9b6"));
  // static DWINGUID CLSID = { 0x76a64158, 0xcb41, 0x11d1, 0x8b, 0x02, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemLocator);
}

// A collection of Named Values
abstract class SWbemNamedValueSet {
  mixin(uuid("9aed384e-ce8b-11d1-8b05-00600806d9b6"));
  // static DWINGUID CLSID = { 0x9aed384e, 0xce8b, 0x11d1, 0x8b, 0x05, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemNamedValueSet);
}

// Object Path
abstract class SWbemObjectPath {
  mixin(uuid("5791bc26-ce9c-11d1-97bf-0000f81e849c"));
  // static DWINGUID CLSID = { 0x5791bc26, 0xce9c, 0x11d1, 0x97, 0xbf, 0x00, 0x00, 0xf8, 0x1e, 0x84, 0x9c };
  mixin Interfaces!(ISWbemObjectPath);
}

// The last error on the current thread
abstract class SWbemLastError {
  mixin(uuid("c2feeeac-cfcd-11d1-8b05-00600806d9b6"));
  // static DWINGUID CLSID = { 0xc2feeeac, 0xcfcd, 0x11d1, 0x8b, 0x05, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemLastError);
}

// A sink for events arising from asynchronous operations
abstract class SWbemSink {
  mixin(uuid("75718c9a-f029-11d1-a1ac-00c04fb6c223"));
  // static DWINGUID CLSID = { 0x75718c9a, 0xf029, 0x11d1, 0xa1, 0xac, 0x00, 0xc0, 0x4f, 0xb6, 0xc2, 0x23 };
  mixin Interfaces!(ISWbemSink);
}

// Date & Time
abstract class SWbemDateTime {
  mixin(uuid("47dfbe54-cf76-11d3-b38f-00105a1f473a"));
  // static DWINGUID CLSID = { 0x47dfbe54, 0xcf76, 0x11d3, 0xb3, 0x8f, 0x00, 0x10, 0x5a, 0x1f, 0x47, 0x3a };
  mixin Interfaces!(ISWbemDateTime);
}

// Refresher
abstract class SWbemRefresher {
  mixin(uuid("d269bf5c-d9c1-11d3-b38f-00105a1f473a"));
  // static DWINGUID CLSID = { 0xd269bf5c, 0xd9c1, 0x11d3, 0xb3, 0x8f, 0x00, 0x10, 0x5a, 0x1f, 0x47, 0x3a };
  mixin Interfaces!(ISWbemRefresher);
}

// A connection to a Namespace
abstract class SWbemServices {
  mixin(uuid("04b83d63-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d63, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemServices);
}

// A connection to a Namespace
abstract class SWbemServicesEx {
  mixin(uuid("62e522dc-8cf3-40a8-8b2e-37d595651e40"));
  // static DWINGUID CLSID = { 0x62e522dc, 0x8cf3, 0x40a8, 0x8b, 0x2e, 0x37, 0xd5, 0x95, 0x65, 0x1e, 0x40 };
  mixin Interfaces!(ISWbemServicesEx);
}

// A Class or Instance
abstract class SWbemObject {
  mixin(uuid("04b83d62-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d62, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemObject);
}

// A Class or Instance
abstract class SWbemObjectEx {
  mixin(uuid("d6bdafb2-9435-491f-bb87-6aa0f0bc31a2"));
  // static DWINGUID CLSID = { 0xd6bdafb2, 0x9435, 0x491f, 0xbb, 0x87, 0x6a, 0xa0, 0xf0, 0xbc, 0x31, 0xa2 };
  mixin Interfaces!(ISWbemObjectEx);
}

// A collection of Classes or Instances
abstract class SWbemObjectSet {
  mixin(uuid("04b83d61-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d61, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemObjectSet);
}

// A named value
abstract class SWbemNamedValue {
  mixin(uuid("04b83d60-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d60, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemNamedValue);
}

// A Qualifier
abstract class SWbemQualifier {
  mixin(uuid("04b83d5f-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d5f, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemQualifier);
}

// A collection of Qualifiers
abstract class SWbemQualifierSet {
  mixin(uuid("04b83d5e-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d5e, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemQualifierSet);
}

// A Property
abstract class SWbemProperty {
  mixin(uuid("04b83d5d-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d5d, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemProperty);
}

// A collection of Properties
abstract class SWbemPropertySet {
  mixin(uuid("04b83d5c-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d5c, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemPropertySet);
}

// A Method
abstract class SWbemMethod {
  mixin(uuid("04b83d5b-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d5b, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemMethod);
}

// A collection of Methods
abstract class SWbemMethodSet {
  mixin(uuid("04b83d5a-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d5a, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemMethodSet);
}

// An Event source
abstract class SWbemEventSource {
  mixin(uuid("04b83d58-21ae-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0x04b83d58, 0x21ae, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemEventSource);
}

// A Security Configurator
abstract class SWbemSecurity {
  mixin(uuid("b54d66e9-2287-11d2-8b33-00600806d9b6"));
  // static DWINGUID CLSID = { 0xb54d66e9, 0x2287, 0x11d2, 0x8b, 0x33, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemSecurity);
}

// A Privilege Override
abstract class SWbemPrivilege {
  mixin(uuid("26ee67bc-5804-11d2-8b4a-00600806d9b6"));
  // static DWINGUID CLSID = { 0x26ee67bc, 0x5804, 0x11d2, 0x8b, 0x4a, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemPrivilege);
}

// A collection of Privilege Overrides
abstract class SWbemPrivilegeSet {
  mixin(uuid("26ee67be-5804-11d2-8b4a-00600806d9b6"));
  // static DWINGUID CLSID = { 0x26ee67be, 0x5804, 0x11d2, 0x8b, 0x4a, 0x00, 0x60, 0x08, 0x06, 0xd9, 0xb6 };
  mixin Interfaces!(ISWbemPrivilegeSet);
}

// A single item from a Refresher
abstract class SWbemRefreshableItem {
  mixin(uuid("8c6854bc-de4b-11d3-b390-00105a1f473a"));
  // static DWINGUID CLSID = { 0x8c6854bc, 0xde4b, 0x11d3, 0xb3, 0x90, 0x00, 0x10, 0x5a, 0x1f, 0x47, 0x3a };
  mixin Interfaces!(ISWbemRefreshableItem);
}
