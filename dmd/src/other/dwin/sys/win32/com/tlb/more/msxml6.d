...
module dwin.sys.win32.com.tlb.more.msxml6;
...
interface IXMLDOMDocument3 : IXMLDOMDocument2 {
  ...
  // static DWINGUID IID = { 0x2933bf96, 0x7b36, 0x11d2, 0xb2, 0x0e, 0x00, 0xc0, 0x4f, 0x98, 0x3e, 0x60 };
...
interface IXMLDOMParseError2 : IXMLDOMParseError {
  ...
  // static DWINGUID IID = { 0x3efaa428, 0x272f, 0x11d2, 0x83, 0x6f, 0x00, 0x00, 0xf8, 0x7a, 0x77, 0x82 };
...
interface IXMLDOMParseErrorCollection : IDispatch {
  ...
  // static DWINGUID IID = { 0x3efaa429, 0x272f, 0x11d2, 0x83, 0x6f, 0x00, 0x00, 0xf8, 0x7a, 0x77, 0x82 };
...
interface IMXXMLFilter : IDispatch {
  ...
  // static DWINGUID IID = { 0xc90352f7, 0x643c, 0x4fbc, 0xbb, 0x23, 0xe9, 0x96, 0xeb, 0x2d, 0x51, 0xfd };
  /*[id(0x0000058F)]*/ int getFeature(wchar* strName, out short fValue);
  /*[id(0x00000591)]*/ int putFeature(wchar* strName, short fValue);
  /*[id(0x00000590)]*/ int getProperty(wchar* strName, out DWINVARIANT varValue);
  /*[id(0x00000592)]*/ int putProperty(wchar* strName, DWINVARIANT varValue);
...
abstract class DOMDocument60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a05, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
...
abstract class FreeThreadedDOMDocument60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a06, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IXMLDOMDocument3);
}
...
abstract class XMLSchemaCache60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a07, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IXMLDOMSchemaCollection2);
}
...
abstract class XSLTemplate60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a08, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IXSLTemplate);
}
...
abstract class XMLHTTP60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a0a, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IXMLHTTPRequest);
}
...
abstract class ServerXMLHTTP60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a0b, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IServerXMLHTTPRequest2);
}
...
abstract class SAXXMLReader60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a0c, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IVBSAXXMLReader, ISAXXMLReader);
}
...
abstract class MXXMLWriter60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a0f, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IMXWriter, ISAXContentHandler, ISAXDeclHandler, ISAXDTDHandler, ISAXErrorHandler, ISAXLexicalHandler, IVBSAXContentHandler, IVBSAXDeclHandler, IVBSAXDTDHandler, IVBSAXErrorHandler, IVBSAXLexicalHandler);
}
...
abstract class MXHTMLWriter60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a10, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IMXWriter, ISAXContentHandler, ISAXDeclHandler, ISAXDTDHandler, ISAXErrorHandler, ISAXLexicalHandler, IVBSAXContentHandler, IVBSAXDeclHandler, IVBSAXDTDHandler, IVBSAXErrorHandler, IVBSAXLexicalHandler);
}
...
abstract class SAXAttributes60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a0e, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IMXAttributes, IVBSAXAttributes, ISAXAttributes);
}
...
abstract class MXNamespaceManager60 {
  ...
  // static DWINGUID CLSID = { 0x88d96a11, 0xf192, 0x11d4, 0xa6, 0x5f, 0x00, 0x40, 0x96, 0x32, 0x51, 0xe5 };
  mixin Interfaces!(IVBMXNamespaceManager, IMXNamespaceManager);
}
