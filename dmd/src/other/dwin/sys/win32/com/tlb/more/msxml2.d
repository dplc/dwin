...
abstract class XMLDocument {
  mixin(uuid("f6d90f10-9c73-11d3-b32e-00c04f990bb4"));
  // static DWINGUID CLSID = { 0xf6d90f10, 0x9c73, 0x11d3, 0xb3, 0x2e, 0x00, 0xc0, 0x4f, 0x99, 0x0b, 0xb4 };
  mixin Interfaces!(IXMLDocument2);
}

// XMLDocument extends IXML Document.  It is obsolete.  You should use DOMDocument.  This object should not be confused with the XMLDocument property on the XML data island.
abstract class XMLDocument26 {
  mixin(uuid("f5078f22-c551-11d3-89b9-0000f81fe221"));
  // static DWINGUID CLSID = { 0xf5078f22, 0xc551, 0x11d3, 0x89, 0xb9, 0x00, 0x00, 0xf8, 0x1f, 0xe2, 0x21 };
  mixin Interfaces!(IXMLDocument2);
}
