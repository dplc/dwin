...
//module dwin.sys.win32.com.tlb.more.tapi3;
module dwin.sys.win32.com.tlb.more.tapi3;
...
interface ITCollection : IDispatch {
  ...
  // static DWINGUID IID = { 0x5ec5acf2, 0x9c02, 0x11d0, 0x83, 0x62, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // Returns number of items in collection.
  /*[id(0x60020000)]*/ int get_Count(out int lCount);
  // Given an index, returns an item in the collection.
  /*[id(0x00000000)]*/ int get_Item(int Index, out DWINVARIANT pVariant);
...
interface ITMediaPlayback : IDispatch {
  ...
  // static DWINGUID IID = { 0x627e8ae6, 0xae4c, 0x4a69, 0xbb, 0x63, 0x2a, 0xd6, 0x25, 0x40, 0x4b, 0x77 };
  // property PlayList
  /*[id(0x00040001)]*/ int set_PlayList(DWINVARIANT pPlayListVariant);
  // property PlayList
  /*[id(0x00040001)]*/ int get_PlayList(out DWINVARIANT pPlayListVariant);
}

// ITMediaRecord Interface
interface ITMediaRecord : IDispatch {
  mixin(uuid("f5dd4592-5476-4cc1-9d4d-fad3eefe7db2"));
  // static DWINGUID IID = { 0xf5dd4592, 0x5476, 0x4cc1, 0x9d, 0x4d, 0xfa, 0xd3, 0xee, 0xfe, 0x7d, 0xb2 };
  // propery FileName
  /*[id(0x00030001)]*/ int set_FileName(wchar* pbstrFileName);
  // propery FileName
...
interface ITCollection2 : ITCollection {
  ...
  // static DWINGUID IID = { 0xe6dddda5, 0xa6d3, 0x48ff, 0x87, 0x37, 0xd3, 0x2f, 0xc4, 0xd9, 0x54, 0x77 };
  // Adds an item to the collection.
  /*[id(0x00000001)]*/ int Add(int Index, DWINVARIANT* pVariant);
...
interface ITCallStateEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x62f47097, 0x95c9, 0x11d0, 0x83, 0x5d, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // property Call
...
interface ITCallInfo : IDispatch {
  ...
  // static DWINGUID IID = { 0x350f85d1, 0x1227, 0x11d3, 0x83, 0xd4, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Address
  ...
  // property CallInfoLong
  /*[id(0x00010005)]*/ int set_CallInfoLong(CALLINFO_LONG CallInfoLong, int plCallInfoLongVal);
  // property CallInfoString
  /*[id(0x00010006)]*/ int get_CallInfoString(CALLINFO_STRING CallInfoString, out wchar* ppCallInfoString);
  // property CallInfoString
  /*[id(0x00010006)]*/ int set_CallInfoString(CALLINFO_STRING CallInfoString, wchar* ppCallInfoString);
  // property CallInfoBuffer
  /*[id(0x00010007)]*/ int get_CallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer, out DWINVARIANT ppCallInfoBuffer);
  // property CallInfoBuffer
  /*[id(0x00010007)]*/ int set_CallInfoBuffer(CALLINFO_BUFFER CallInfoBuffer, DWINVARIANT ppCallInfoBuffer);
...
interface ITAddress : IDispatch {
  ...
  // static DWINGUID IID = { 0xb1efc386, 0x9355, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // property State
  ...
  // property Calls
  /*[id(0x00010006)]*/ int get_Calls(out DWINVARIANT pVariant);
  ...
  /*[id(0x0001000E)]*/ int set_MessageWaiting(short pfMessageWaiting);
  // property MessageWaiting
  /*[id(0x0001000E)]*/ int get_MessageWaiting(out short pfMessageWaiting);
  // property DoNotDisturb
  /*[id(0x0001000F)]*/ int set_DoNotDisturb(short pfDoNotDisturb);
  // property DoNotDisturb
...
interface ITTAPI : IDispatch {
  ...
  // static DWINGUID IID = { 0xb1efc382, 0x9355, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // Initialize
  /*[id(0x0001000D)]*/ int Initialize();
  // Shutdown
  /*[id(0x0001000E)]*/ int Shutdown();
  // property Addresses
  /*[id(0x00010001)]*/ int get_Addresses(out DWINVARIANT pVariant);
  ...
  /*[id(0x0001000F)]*/ int set_EventFilter(int plFilterMask);
  // property EventFilter
...
interface IEnumAddress : IUnknown {
  ...
  // static DWINGUID IID = { 0x1666fca1, 0x9363, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
...
interface IEnumCallHub : IUnknown {
  ...
  // static DWINGUID IID = { 0xa3c15450, 0x5b92, 0x11d1, 0x8f, 0x4e, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
...
interface ITCallHub : IDispatch {
  ...
  // static DWINGUID IID = { 0xa3c1544e, 0x5b92, 0x11d1, 0x8f, 0x4e, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // method Clear
  /*[id(0x00000001)]*/ int Clear();
  // method EnumerateCalls
  /*[id(0x00000002)]*/ int EnumerateCalls(out IEnumCall ppEnumCall);
  // property Calls
  /*[id(0x00000003)]*/ int get_Calls(out DWINVARIANT pCalls);
  // property NumCalls
...
interface IEnumCall : IUnknown {
  ...
  // static DWINGUID IID = { 0xae269cf6, 0x935e, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
...
interface ITBasicCallControl : IDispatch {
  ...
  // static DWINGUID IID = { 0xb1efc389, 0x9355, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // method Connect
...
interface ITForwardInformation : IDispatch {
  ...
  // static DWINGUID IID = { 0x449f659e, 0x88a3, 0x11d1, 0xbb, 0x5d, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property NumRingsNoAnswer
  /*[id(0x00000001)]*/ int set_NumRingsNoAnswer(int plNumRings);
  // property NumRingsNoAnswer
...
interface ITCallNotificationEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x895801df, 0x3dd6, 0x11d1, 0x8f, 0x30, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Call
...
interface ITTAPIEventNotification : IUnknown {
  ...
  // static DWINGUID IID = { 0xeddb9426, 0x3b91, 0x11d1, 0x8f, 0x30, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // method Event
...
interface ITBasicAudioTerminal : IDispatch {
  ...
  // static DWINGUID IID = { 0xb1efc38d, 0x9355, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // property Volume
  /*[id(0x00000001)]*/ int set_Volume(int plVolume);
  // property Volume
  /*[id(0x00000001)]*/ int get_Volume(out int plVolume);
  // property Balance
  /*[id(0x00000002)]*/ int set_Balance(int plBalance);
  // property Balance
...
interface ITCallHubEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xa3c15451, 0x5b92, 0x11d1, 0x8f, 0x4e, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Event
...
interface ITForwardInformation2 : ITForwardInformation {
  ...
  // static DWINGUID IID = { 0x5229b4ed, 0xb260, 0x4382, 0x8e, 0x1a, 0x5d, 0xf3, 0xa8, 0xa4, 0xcc, 0xc0 };
...
interface ITAddressCapabilities : IDispatch {
  ...
  // static DWINGUID IID = { 0x8df232f5, 0x821b, 0x11d1, 0xbb, 0x5c, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
...
interface ITQOSEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xcfa3357c, 0xad77, 0x11d1, 0xbb, 0x68, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property CallHub
  /*[id(0x00000001)]*/ int get_Call(out ITCallInfo ppCall);
  // property Event
...
interface ITAddressEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x831ce2d1, 0x83b5, 0x11d1, 0xbb, 0x5c, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Address
...
interface ITAddressDeviceSpecificEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x3acb216b, 0x40bd, 0x487a, 0x86, 0x72, 0x5c, 0xe7, 0x7b, 0xd7, 0xe3, 0xa3 };
  // property Address
  /*[id(0x00000001)]*/ int get_Address(out ITAddress ppAddress);
  // property Call
...
interface ITCallMediaEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xff36b87f, 0xec3a, 0x11d0, 0x8e, 0xe4, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Call
  /*[id(0x00000001)]*/ int get_Call(out ITCallInfo ppCallInfo);
  // property Event
...
interface ITTAPIObjectEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xf4854d48, 0x937a, 0x11d1, 0xbb, 0x58, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property TAPIObject
...
interface ITTAPIObjectEvent2 : ITTAPIObjectEvent {
  ...
  // static DWINGUID IID = { 0x359dda6e, 0x68ce, 0x4383, 0xbf, 0x0b, 0x16, 0x91, 0x33, 0xc4, 0x1b, 0x46 };
  // property Phone
...
interface ITPhone : IDispatch {
  ...
  // static DWINGUID IID = { 0x09d48db4, 0x10cc, 0x4388, 0x9d, 0xe7, 0xa8, 0x46, 0x56, 0x18, 0x97, 0x5a };
  // method Open
  /*[id(0x00010001)]*/ int Open(PHONE_PRIVILEGE Privilege);
  // method Close
  /*[id(0x00010002)]*/ int Close();
  // property Addresses
  /*[id(0x00010003)]*/ int get_Addresses(out DWINVARIANT pAddresses);
  // method EnumerateAddresses
  ...
  // property Terminals
  /*[id(0x00010007)]*/ int get_Terminals(ITAddress pAddress, out DWINVARIANT pTerminals);
  ...
  // property ButtonMode
  /*[id(0x00010009)]*/ int set_ButtonMode(int lButtonID, PHONE_BUTTON_MODE pButtonMode);
  // property ButtonFunction
  /*[id(0x0001000A)]*/ int get_ButtonFunction(int lButtonID, out PHONE_BUTTON_FUNCTION pButtonFunction);
  // property ButtonFunction
  /*[id(0x0001000A)]*/ int set_ButtonFunction(int lButtonID, PHONE_BUTTON_FUNCTION pButtonFunction);
  // property ButtonText
  /*[id(0x0001000B)]*/ int get_ButtonText(int lButtonID, out wchar* ppButtonText);
  // property ButtonText
  /*[id(0x0001000B)]*/ int set_ButtonText(int lButtonID, wchar* ppButtonText);
  ...
  // property HookSwitchState
  /*[id(0x0001000D)]*/ int set_HookSwitchState(PHONE_HOOK_SWITCH_DEVICE HookSwitchDevice, PHONE_HOOK_SWITCH_STATE pHookSwitchState);
  // property RingMode
  /*[id(0x0001000E)]*/ int set_RingMode(int plRingMode);
  // property RingMode
  /*[id(0x0001000E)]*/ int get_RingMode(out int plRingMode);
  // property RingVolume
  /*[id(0x0001000F)]*/ int set_RingVolume(int plRingVolume);
  // property RingVolume
  ...
  /*[id(0x00010012)]*/ int get_PhoneCapsBuffer(PHONECAPS_BUFFER pcbCaps, out DWINVARIANT pVarBuffer);
  // property LampMode
  /*[id(0x00010013)]*/ int get_LampMode(int lLampID, out PHONE_LAMP_MODE pLampMode);
  // property LampMode
  /*[id(0x00010013)]*/ int set_LampMode(int lLampID, PHONE_LAMP_MODE pLampMode);
  // property Display
  ...
  /*[id(0x00010016)]*/ int get_PreferredAddresses(out DWINVARIANT pAddresses);
  ...
  /*[id(0x00010019)]*/ int DeviceSpecificVariant(DWINVARIANT varDevSpecificByteArray);
...
interface ITAddressTranslation : IDispatch {
  ...
  // static DWINGUID IID = { 0x0c4d8f03, 0x8ddb, 0x11d1, 0xa0, 0x9e, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  ...
  // property Locations
  /*[id(0x00040004)]*/ int get_Locations(out DWINVARIANT pVariant);
  ...
  /*[id(0x00040006)]*/ int get_CallingCards(out DWINVARIANT pVariant);
}
...
interface ITAddressTranslationInfo : IDispatch {
  ...
  // static DWINGUID IID = { 0xafc15945, 0x8d40, 0x11d1, 0xa0, 0x9e, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface IEnumLocation : IUnknown {
  ...
  // static DWINGUID IID = { 0x0c4d8f01, 0x8ddb, 0x11d1, 0xa0, 0x9e, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITLocationInfo : IDispatch {
  ...
  // static DWINGUID IID = { 0x0c4d8eff, 0x8ddb, 0x11d1, 0xa0, 0x9e, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface IEnumCallingCard : IUnknown {
  ...
  // static DWINGUID IID = { 0x0c4d8f02, 0x8ddb, 0x11d1, 0xa0, 0x9e, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITCallingCard : IDispatch {
  ...
  // static DWINGUID IID = { 0x0c4d8f00, 0x8ddb, 0x11d1, 0xa0, 0x9e, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITAgent : IDispatch {
  ...
  // static DWINGUID IID = { 0x5770ece5, 0x4b27, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  ...
  // property State
  /*[id(0x00000006)]*/ int set_State(AGENT_STATE pAgentState);
  // property State
  /*[id(0x00000006)]*/ int get_State(out AGENT_STATE pAgentState);
  // property MeasurementPeriod
  /*[id(0x00000007)]*/ int set_MeasurementPeriod(int plPeriod);
  // property MeasurementPeriod
  ...
  /*[id(0x0000000F)]*/ int get_AgentSessions(out DWINVARIANT pVariant);
}

// TAPI 3.0 IEnumAgentSession interface
interface IEnumAgentSession : IUnknown {
  mixin(uuid("5afc314e-4bcc-11d1-bf80-00805fc147d3"));
  // static DWINGUID IID = { 0x5afc314e, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITAgentSession : IDispatch {
  ...
  // static DWINGUID IID = { 0x5afc3147, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property Agent
  ...
  // property State
  /*[id(0x00000004)]*/ int set_State(AGENT_SESSION_STATE pSessionState);
  // property State
...
interface ITACDGroup : IDispatch {
  ...
  // static DWINGUID IID = { 0x5afc3148, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property Name
  /*[id(0x00000001)]*/ int get_Name(out wchar* ppName);
  // method EnumerateQueues
  /*[id(0x00000002)]*/ int EnumerateQueues(out IEnumQueue ppEnumQueue);
  // property Queues
  /*[id(0x00000003)]*/ int get_Queues(out DWINVARIANT pVariant);
}

// TAPI 3.0 IEnumQueue interface
interface IEnumQueue : IUnknown {
  mixin(uuid("5afc3158-4bcc-11d1-bf80-00805fc147d3"));
  // static DWINGUID IID = { 0x5afc3158, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITQueue : IDispatch {
  ...
  // static DWINGUID IID = { 0x5afc3149, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property MeasurementPeriod
  /*[id(0x00000001)]*/ int set_MeasurementPeriod(int plPeriod);
  // property MeasurementPeriod
...
interface ITAgentEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x5afc314a, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property Agent
  /*[id(0x00000001)]*/ int get_Agent(out ITAgent ppAgent);
  // property Event
...
interface ITAgentSessionEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x5afc314b, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property Session
...
interface ITACDGroupEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x297f3032, 0xbd11, 0x11d1, 0xa0, 0xa7, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property Group
...
interface ITQueueEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x297f3033, 0xbd11, 0x11d1, 0xa0, 0xa7, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property Queue
...
interface ITTAPICallCenter : IDispatch {
  ...
  // static DWINGUID IID = { 0x5afc3154, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  ...
  /*[id(0x00020002)]*/ int get_AgentHandlers(out DWINVARIANT pVariant);
}

// TAPI 3.0 IEnumAgentHandler interface
interface IEnumAgentHandler : IUnknown {
  mixin(uuid("587e8c28-9802-11d1-a0a4-00805fc147d3"));
  // static DWINGUID IID = { 0x587e8c28, 0x9802, 0x11d1, 0xa0, 0xa4, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITAgentHandler : IDispatch {
  ...
  // static DWINGUID IID = { 0x587e8c22, 0x9802, 0x11d1, 0xa0, 0xa4, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
  // property Name
  /*[id(0x00000001)]*/ int get_Name(out wchar* ppName);
  ...
  // property ACDGroups
  /*[id(0x00000006)]*/ int get_ACDGroups(out DWINVARIANT pVariant);
  // property UsableAddresses
  /*[id(0x00000007)]*/ int get_UsableAddresses(out DWINVARIANT pVariant);
}

// TAPI 3.0 IEnumACDGroup interface
interface IEnumACDGroup : IUnknown {
  mixin(uuid("5afc3157-4bcc-11d1-bf80-00805fc147d3"));
  // static DWINGUID IID = { 0x5afc3157, 0x4bcc, 0x11d1, 0xbf, 0x80, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITAgentHandlerEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x297f3034, 0xbd11, 0x11d1, 0xa0, 0xa7, 0x00, 0x80, 0x5f, 0xc1, 0x47, 0xd3 };
...
interface ITCallInfoChangeEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x5d4b65f9, 0xe51c, 0x11d1, 0xa0, 0x2f, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Call
  /*[id(0x00000001)]*/ int get_Call(out ITCallInfo ppCall);
  // property Cause
...
interface ITRequestEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xac48ffde, 0xf8c4, 0x11d1, 0xa0, 0x30, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
...
interface ITMediaSupport : IDispatch {
  ...
  // static DWINGUID IID = { 0xb1efc384, 0x9355, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // property MediaTypes
...
interface ITTerminalSupport : IDispatch {
  ...
  // static DWINGUID IID = { 0xb1efc385, 0x9355, 0x11d0, 0x83, 0x5c, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  // property StaticTerminals
  /*[id(0x00060001)]*/ int get_StaticTerminals(out DWINVARIANT pVariant);
  ...
  /*[id(0x00060003)]*/ int get_DynamicTerminalClasses(out DWINVARIANT pVariant);
...
interface ITTerminalSupport2 : ITTerminalSupport {
  ...
  // static DWINGUID IID = { 0xf3eb39bc, 0x1b1f, 0x4e99, 0xa0, 0xc0, 0x56, 0x30, 0x5c, 0x4d, 0xd5, 0x91 };
  // property PluggableSuperclasses
  /*[id(0x00060007)]*/ int get_PluggableSuperclasses(out DWINVARIANT pVariant);
  ...
  /*[id(0x00060009)]*/ int get_PluggableTerminalClasses(wchar* bstrTerminalSuperclass, int lMediaType, out DWINVARIANT pVariant);
  // method EnumeratePluggableTerminalClasses
  /*[id(0x0006000A)]*/ int EnumeratePluggableTerminalClasses(DWINGUID iidTerminalSuperclass, int lMediaType, out IEnumPluggableTerminalClassInfo ppClassEnumerator);
}
...
interface IEnumPluggableSuperclassInfo : IUnknown {
  ...
  // static DWINGUID IID = { 0xe9586a80, 0x89e6, 0x4cff, 0x93, 0x1d, 0x47, 0x8d, 0x57, 0x51, 0xf4, 0xc0 };
...
interface ITPluggableTerminalSuperclassInfo : IDispatch {
  ...
  // static DWINGUID IID = { 0x6d54e42c, 0x4625, 0x4359, 0xa6, 0xf7, 0x63, 0x19, 0x99, 0x10, 0x7e, 0x05 };
  // method get_Name
...
interface IEnumPluggableTerminalClassInfo : IUnknown {
  ...
  // static DWINGUID IID = { 0x4567450c, 0xdbee, 0x4e3f, 0xaa, 0xf5, 0x37, 0xbf, 0x9e, 0xbf, 0x5e, 0x29 };
...
interface ITPluggableTerminalClassInfo : IDispatch {
  ...
  // static DWINGUID IID = { 0x41757f4a, 0xcf09, 0x4b34, 0xbc, 0x96, 0x0a, 0x79, 0xd2, 0x39, 0x00, 0x76 };
  // method get_Name
  /*[id(0x00000001)]*/ int get_Name(out wchar* pName);
  // method get_Company
...
interface ITStreamControl : IDispatch {
  ...
  // static DWINGUID IID = { 0xee3bd604, 0x3868, 0x11d2, 0xa0, 0x45, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // method CreateStream
  ...
  // property Streams
  /*[id(0x00040004)]*/ int get_Streams(out DWINVARIANT pVariant);
}

// IEnumStream interface
interface IEnumStream : IUnknown {
  mixin(uuid("ee3bd606-3868-11d2-a045-00c04fb6809f"));
  // static DWINGUID IID = { 0xee3bd606, 0x3868, 0x11d2, 0xa0, 0x45, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
...
interface ITSubStreamControl : IDispatch {
  ...
  // static DWINGUID IID = { 0xee3bd607, 0x3868, 0x11d2, 0xa0, 0x45, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  ...
  // property SubStreams
  /*[id(0x00000004)]*/ int get_SubStreams(out DWINVARIANT pVariant);
}

// ITSubStream interface
interface ITSubStream : IDispatch {
  mixin(uuid("ee3bd608-3868-11d2-a045-00c04fb6809f"));
  // static DWINGUID IID = { 0xee3bd608, 0x3868, 0x11d2, 0xa0, 0x45, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // method StartStream
  ...
  // property Terminals
  /*[id(0x00000007)]*/ int get_Terminals(out DWINVARIANT pTerminals);
  // property Stream
...
interface IEnumSubStream : IUnknown {
  ...
  // static DWINGUID IID = { 0xee3bd609, 0x3868, 0x11d2, 0xa0, 0x45, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
...
interface ITLegacyAddressMediaControl : IUnknown {
  ...
  // static DWINGUID IID = { 0xab493640, 0x4c0b, 0x11d2, 0xa0, 0x46, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
...
interface ITLegacyAddressMediaControl2 : ITLegacyAddressMediaControl {
  ...
  // static DWINGUID IID = { 0xb0ee512b, 0xa531, 0x409e, 0x9d, 0xd9, 0x40, 0x99, 0xfe, 0x86, 0xc7, 0x38 };
...
interface ITLegacyCallMediaControl : IDispatch {
  ...
  // static DWINGUID IID = { 0xd624582f, 0xcc23, 0x4436, 0xb8, 0xa5, 0x47, 0xc6, 0x25, 0xc8, 0x04, 0x5d };
  // method DetectDigits
...
interface ITLegacyCallMediaControl2 : ITLegacyCallMediaControl {
  ...
  // static DWINGUID IID = { 0x57ca332d, 0x7bc2, 0x44f1, 0xa6, 0x0c, 0x93, 0x6f, 0xe8, 0xd7, 0xce, 0x73 };
...
interface ITDigitDetectionEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x80d3bfac, 0x57d9, 0x11d2, 0xa0, 0x4a, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Call
  /*[id(0x00000001)]*/ int get_Call(out ITCallInfo ppCallInfo);
  // property Digit
...
interface ITDigitGenerationEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x80d3bfad, 0x57d9, 0x11d2, 0xa0, 0x4a, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // property Call
  /*[id(0x00000001)]*/ int get_Call(out ITCallInfo ppCallInfo);
...
interface ITDigitsGatheredEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xe52ec4c1, 0xcba3, 0x441a, 0x9e, 0x6a, 0x93, 0xcb, 0x90, 0x9e, 0x97, 0x24 };
  // property Call
  /*[id(0x00000001)]*/ int get_Call(out ITCallInfo ppCallInfo);
  // property Digits
...
interface ITToneDetectionEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x407e0faf, 0xd047, 0x4753, 0xb0, 0xc6, 0x8e, 0x06, 0x03, 0x73, 0xfe, 0xcd };
  // property Call
  /*[id(0x00000001)]*/ int get_Call(out ITCallInfo ppCallInfo);
  // property AppSpecific
...
interface ITPrivateEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x0e269cd0, 0x10d4, 0x4121, 0x9c, 0x22, 0x9c, 0x85, 0xd6, 0x25, 0x65, 0x0d };
  // property Address
  /*[id(0x00000001)]*/ int get_Address(out ITAddress ppAddress);
  // property Call
...
interface ITAddress2 : ITAddress {
  ...
  // static DWINGUID IID = { 0xb0ae5d9b, 0xbe51, 0x46c9, 0xb0, 0xf7, 0xdf, 0xa8, 0xa2, 0x2a, 0x8b, 0xc4 };
  // property Phones
  /*[id(0x00010010)]*/ int get_Phones(out DWINVARIANT pPhones);
  ...
  /*[id(0x00010014)]*/ int get_PreferredPhones(out DWINVARIANT pPhones);
  ...
  // method EventFilter
  /*[id(0x00010013)]*/ int set_EventFilter(TAPI_EVENT TapiEvent, int lSubEvent, short pEnable);
  // method DeviceSpecific
  /*[id(0x00010016)]*/ int DeviceSpecific(ITCallInfo pCall, ubyte* pParams, uint dwSize);
  // method DeviceSpecificVariant
  /*[id(0x00010017)]*/ int DeviceSpecificVariant(ITCallInfo pCall, DWINVARIANT varDevSpecificByteArray);
  // method NegotiateExtVersion
...
interface IEnumPhone : IUnknown {
  ...
  // static DWINGUID IID = { 0xf15b7669, 0x4780, 0x4595, 0x8c, 0x89, 0xfb, 0x36, 0x9c, 0x8c, 0xf7, 0xaa };
...
interface ITTAPI2 : ITTAPI {
  ...
  // static DWINGUID IID = { 0x54fbdc8c, 0xd90f, 0x4dad, 0x96, 0x95, 0xb3, 0x73, 0x09, 0x7f, 0x09, 0x4b };
  // property Phones
  /*[id(0x00010010)]*/ int get_Phones(out DWINVARIANT pPhones);
  // method EnumeratePhones
  /*[id(0x00010011)]*/ int EnumeratePhones(out IEnumPhone ppEnumPhone);
...
interface ITMultiTrackTerminal : IDispatch {
  ...
  // static DWINGUID IID = { 0xfe040091, 0xade8, 0x4072, 0x95, 0xc9, 0xbf, 0x7d, 0xe8, 0xc5, 0x4b, 0x44 };
  // property TrackTerminals
  /*[id(0x00010001)]*/ int get_TrackTerminals(out DWINVARIANT pVariant);
...
interface ITStaticAudioTerminal : IDispatch {
  ...
  // static DWINGUID IID = { 0xa86b7871, 0xd14c, 0x48e6, 0x92, 0x2e, 0xa8, 0xd1, 0x5f, 0x98, 0x48, 0x00 };
  // property WaveId
...
interface ITBasicCallControl2 : ITBasicCallControl {
  ...
  // static DWINGUID IID = { 0x161a4a56, 0x1e99, 0x4b3f, 0xa4, 0x6a, 0x16, 0x8f, 0x38, 0xa5, 0xee, 0x4c };
...
interface ITAutomatedPhoneControl : IDispatch {
  ...
  // static DWINGUID IID = { 0x1ee1af0e, 0x6159, 0x4a61, 0xb7, 0x9b, 0x6a, 0x4b, 0xa3, 0xfc, 0x9d, 0xfc };
  // method StartTone
  ...
  /*[id(0x00020015)]*/ int get_SelectedCalls(out DWINVARIANT pVariant);
}

// ITMediaControl Interface
interface ITMediaControl : IDispatch {
  mixin(uuid("c445dde8-5199-4bc7-9807-5ffb92e42e09"));
  // static DWINGUID IID = { 0xc445dde8, 0x5199, 0x4bc7, 0x98, 0x07, 0x5f, 0xfb, 0x92, 0xe4, 0x2e, 0x09 };
  // method Start
...
interface ITCallInfo2 : ITCallInfo {
  ...
  // static DWINGUID IID = { 0x94d70ca6, 0x7ab0, 0x4daa, 0x81, 0xca, 0xb8, 0xf8, 0x64, 0x3f, 0xae, 0xc1 };
  // method EventFilter
  /*[id(0x0001000B)]*/ int get_EventFilter(TAPI_EVENT TapiEvent, int lSubEvent, out short pEnable);
  // method EventFilter
  /*[id(0x0001000B)]*/ int set_EventFilter(TAPI_EVENT TapiEvent, int lSubEvent, short pEnable);
}
...
interface ITFileTerminalEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xe4a7fbac, 0x8c17, 0x4427, 0x9f, 0x55, 0x9f, 0x58, 0x9a, 0xc8, 0xaf, 0x00 };
  // property Terminal
...
interface ITToneTerminalEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xe6f56009, 0x611f, 0x4945, 0xbb, 0xd2, 0x2d, 0x0c, 0xe5, 0x61, 0x20, 0x56 };
  // property Terminal
  /*[id(0x00000001)]*/ int get_Terminal(out ITTerminal ppTerminal);
  // property Call
  /*[id(0x00000002)]*/ int get_Call(out ITCallInfo ppCall);
...
interface ITASRTerminalEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xee016a02, 0x4fa9, 0x467c, 0x93, 0x3f, 0x5a, 0x15, 0xb1, 0x23, 0x77, 0xd7 };
  // property Terminal
  /*[id(0x00000001)]*/ int get_Terminal(out ITTerminal ppTerminal);
  // property Call
  /*[id(0x00000002)]*/ int get_Call(out ITCallInfo ppCall);
...
interface ITTTSTerminalEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0xd964788f, 0x95a5, 0x461d, 0xab, 0x0c, 0xb9, 0x90, 0x0a, 0x6c, 0x27, 0x13 };
  // property Terminal
  /*[id(0x00000001)]*/ int get_Terminal(out ITTerminal ppTerminal);
  // property Call
  /*[id(0x00000002)]*/ int get_Call(out ITCallInfo ppCall);
...
interface ITPhoneEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x8f942dd8, 0x64ed, 0x4aaf, 0xa7, 0x7d, 0xb2, 0x3d, 0xb0, 0x83, 0x7e, 0xad };
  // property Phone
...
interface ITPhoneDeviceSpecificEvent : IDispatch {
  ...
  // static DWINGUID IID = { 0x63ffb2a6, 0x872b, 0x4cd3, 0xa5, 0x01, 0x32, 0x6e, 0x8f, 0xb4, 0x0a, 0xf7 };
  // property Phone
  /*[id(0x00000001)]*/ int get_Phone(out ITPhone ppPhone);
  // property lParam1
...
interface ITLegacyWaveSupport : IDispatch {
  ...
  // static DWINGUID IID = { 0x207823ea, 0xe252, 0x11d2, 0xb7, 0x7e, 0x00, 0x80, 0xc7, 0x13, 0x53, 0x81 };
...
interface ITTAPIDispatchEventNotification : IDispatch {
  ...
  // static DWINGUID IID = { 0x9f34325b, 0x7e62, 0x11d2, 0x94, 0x57, 0x00, 0xc0, 0x4f, 0x8e, 0xc8, 0x88 };
  /+// method Event
  /*[id(0x00000001)]*/ int Event(TAPI_EVENT TapiEvent, IDispatch pEvent);+/
}
...
interface ITDispatchMapper : IDispatch {
  ...
  // static DWINGUID IID = { 0xe9225295, 0xc759, 0x11d1, 0xa0, 0x2b, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
...
interface ITRequest : IDispatch {
  ...
  // static DWINGUID IID = { 0xac48ffdf, 0xf8c4, 0x11d1, 0xa0, 0x30, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  // method MakeCall
...
abstract class TAPI {
  ...
  // static DWINGUID CLSID = { 0x21d6d48e, 0xa88b, 0x11d0, 0x83, 0xdd, 0x00, 0xaa, 0x00, 0x3c, 0xca, 0xbd };
  mixin Interfaces!(ITTAPI, ITTAPICallCenter);
}

// TAPI 3.0 DispatchMapper Object
abstract class DispatchMapper {
  mixin(uuid("e9225296-c759-11d1-a02b-00c04fb6809f"));
  // static DWINGUID CLSID = { 0xe9225296, 0xc759, 0x11d1, 0xa0, 0x2b, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
  mixin Interfaces!(ITDispatchMapper);
}

// TAPI 3.0 RequestMakeCall Object
abstract class RequestMakeCall {
  mixin(uuid("ac48ffe0-f8c4-11d1-a030-00c04fb6809f"));
  // static DWINGUID CLSID = { 0xac48ffe0, 0xf8c4, 0x11d1, 0xa0, 0x30, 0x00, 0xc0, 0x4f, 0xb6, 0x80, 0x9f };
