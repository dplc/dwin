...
set dfl_libs=%dwin_path%\lib\gdi32.lib %dwin_path%\lib\comctl32.lib %dwin_path%\lib\advapi32.lib %dwin_path%\lib\comdlg32.lib %dwin_path%\lib\ole32.lib %dwin_path%\lib\uuid.lib %dwin_path%\lib\ws2_32.lib %dfl_libs_dfl%

@rem   -version=NO_DRAG_DROP -version=NO_MDI
@rem   -debug=SHOW_MESSAGE_INFO -debug=MESSAGE_PAUSE
rem set dfl_flags=%dfl_flags% -debug=SHOW_MESSAGENFO -version=DFL_TangoNetDeviceBerkeley
set _dfl_flags=%dfl_flags% -version=DFL_TangoNetDeviceBerkeley
